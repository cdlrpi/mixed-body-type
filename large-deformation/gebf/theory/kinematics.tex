...
% Using the coordinate $\alpha_{1}$ as the location of a rigid cross-section of the beam along the beam's centerline and $\alpha_{2} \ \& \ \alpha_{3}$ as the coordinates that locate a point in the cross section from the centerline, the position of any point ($\vec{x}_{p}$) in the beam can be described as
% \begin{align}
%   \left\{ \vec{x}_{p} \right\}_{N} =& \left\{ \vec{x} \right\}_{N} + 
%   \label{pos}
%   \end{align}
% 
% . \\ 
